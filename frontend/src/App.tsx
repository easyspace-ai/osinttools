...
function LoginRoute() {
  ...
  return (
    <LoginPage onLoginSuccess={() => navigate(from, { replace: true })} />
  );
}
...
function GuestOnly({ children }: { children: React.ReactNode }) {
  ...
  if (user) {
    return <Navigate to={DEFAULT_AUTH_HOME} replace />;
  }
  return <>{children}</>;
}
          ...
          <div className="flex h-screen w-full bg-gray-50 dark:bg-gray-950 overflow-hidden font-sans selection:bg-blue-100 dark:selection:bg-blue-900/50">
            ...
            >
              ...
              <div className="flex-1 flex flex-col min-h-0 overflow-hidden">
                <Routes>
                  <Route path="/" element={<Navigate to={DEFAULT_AUTH_HOME} replace />} />
