...
export function SkillEditorWorkspace({
  ...
  return (
    <Dialog open={open} onOpenChange={(v) => !v && handleClose()}>
      ...
      >
        {/* Toolbar */}
        <header className="flex items-center gap-2 h-12 px-4 border-b border-gray-200 dark:border-gray-800 bg-gray-50 dark:bg-gray-900 shrink-0 min-w-0">
          ...
          <div className="flex items-center gap-2 shrink-0 ml-1">
            ...
            <button
              ...
              className="p-1.5 rounded-md hover:bg-gray-200 dark:hover:bg-gray-800 text-gray-500 shrink-0 ml-0.5"
